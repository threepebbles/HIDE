...
_DIRECTORY = os.path.abspath(os.path.join('C:/Users/이은영',
                                          'Links/link.{59031a47-3f72-44a7-89c5-5595fe6b30ee}'))
_USERDATA_PATH = os.path.join(_DIRECTORY,
                              hashlib.sha256(' '.join(['이은영', 'HIDEUSERDATA']).encode()).hexdigest())
...
def set_userdata(username, password):
    if not os.path.isdir(os.path.abspath(os.path.join('C:/Users/이은영',
                                                      'Links/link.{59031a47-3f72-44a7-89c5-5595fe6b30ee}'))):
        os.mkdir(os.path.abspath(os.path.join('C:/Users/이은영',
                                              'Links/link.{59031a47-3f72-44a7-89c5-5595fe6b30ee}')))
